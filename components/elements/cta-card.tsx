  ...
  return (
    <div className='relative px-6 py-10 rounded-md bg-slate-100'>
        ...
        <Image
            ...
            src="https://images.unsplash.com/photo-1641128324972-af3212f0f6bd?ixid=MnwzODU2NTF8MHwxfHNlYXJjaHwxN3x8Q2FwcGFkb2NpYXxlbnwwfHx8fDE2NzAzMjI2OTE&ixlib=rb-4.0.3"/>
