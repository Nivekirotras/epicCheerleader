  ...
  return (
    <div className='relative px-6 py-10 rounded-md bg-slate-100'>
        ...
        <div className='relative z-20'>
            ...
            <p className='mt-2 max-w-lg text-xl'>Get a bliss of the best tips to grow your self-confidence on a daily basis. The latest from research to your inbox</p>
            {/* Form */}
            <form 
            ...
            <div className='mt-5 text-neutral-700'>
              Join our <span className='px-2 py-1 text-sm rounded-md bg-neutral-700 text-neutral-100'>1500+</span>
              {" "}subscribers now!              
              </div>
        </div>
