    ...
    return (
      <div className='flex gap-10 md:gap-8'>
          ...
          <div className="">
              ...
              <p className="mb-6 text-md lg:text-xl text-gray-700 leading-loose">The truth is, the most significant believer, supporter, and cheerleader in your life should be you. This isn't just a feel-good mantra; it's a fundamental shift in how we approach life. Empowering ourselves isn't a luxury; it’s a necessity. This manifesto is more than words; it's a call to action. It’s an invitation to step into the arena of self-celebration. To recognize that while it's easy to be a supporter for others, the real challenge, and the most rewarding one, is learning to be your own.</p>
