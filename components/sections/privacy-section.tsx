...
const PrivacySection = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <p className="text-sm text-gray-500 mb-6">Last updated: February 12, 2025</p>
      ...
      <h2 className="text-3xl font-bold mt-10 mb-4">Interpretation and Definitions</h2>
      ...
      <ul className="list-disc ml-6 mb-4 space-y-2">
        ...
        <li>
          <p className="leading-relaxed">
            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Epic
            Cheerleader.
          </p>
        </li>
        <li>
        ...
        <li>
          <p className="leading-relaxed">
            <strong>Website</strong> refers to Epic Cheerleader, accessible from{' '}
            <a
              href="https://epiccheerleader.com"
              rel="external nofollow noopener"
              target="_blank"
              className="text-blue-600 underline"
            >
              https://epiccheerleader.com
            </a>
          </p>
        </li>
        <li>
      ...
      <h2 className="text-3xl font-bold mt-10 mb-4">Collecting and Using Your Personal Data</h2>
      ...
      <p className="mb-4 leading-relaxed">
        When You access the Service by or through a mobile device, We may collect certain information automatically, including, but is
      ...
      <ul className="list-disc ml-6 mb-4 space-y-2">
        <li>
          <p className="leading-relaxed">Google</p>
        </li>
        <li>
          <p className="leading-relaxed">Facebook</p>
        </li>
        <li>
      ...
      <ul className="list-disc ml-6 mb-4 space-y-2">
        ...
        <li>
          <p className="leading-relaxed">
            ...
            users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity
      ...
      <p className="mb-4 leading-relaxed">
        ...
        offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies on{' '}
        <a
      ...
      <ul className="list-disc ml-6 mb-4 space-y-2">
        <li>
          ...
          <p className="leading-relaxed">Type: Session Cookies</p>
          <p className="leading-relaxed">Administered by: Us</p>
          <p className="leading-relaxed">
        ...
        <li>
          ...
          <p className="leading-relaxed">Type: Persistent Cookies</p>
          <p className="leading-relaxed">Administered by: Us</p>
          <p className="leading-relaxed">
      ...
      <ul className="list-disc ml-6 mb-4 space-y-2">
        <li>
          <p className="leading-relaxed">Comply with a legal obligation</p>
        </li>
        <li>
          <p className="leading-relaxed">Protect and defend the rights or property of the Company</p>
        </li>
        <li>
          <p className="leading-relaxed">Prevent or investigate possible wrongdoing in connection with the Service</p>
        </li>
        <li>
          <p className="leading-relaxed">Protect the personal safety of Users of the Service or the public</p>
        </li>
        <li>
          <p className="leading-relaxed">Protect against legal liability</p>
        </li>
      </ul>
      ...
      <h2 className="text-3xl font-bold mt-10 mb-4">Children's Privacy</h2>
      <p className="mb-4 leading-relaxed">
      ...
      <h2 className="text-3xl font-bold mt-10 mb-4">Links to Other Websites</h2>
      <p className="mb-4 leading-relaxed">
      ...
      <h2 className="text-3xl font-bold mt-10 mb-4">Changes to this Privacy Policy</h2>
      <p className="mb-4 leading-relaxed">
      ...
      <ul className="list-disc ml-6 mb-4 space-y-2">
        <li>
          <p className="leading-relaxed">By email: hello@epiccheerleader.com</p>
        </li>
      </ul>
    </div>
  );
